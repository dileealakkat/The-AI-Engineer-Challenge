...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col bg-zinc-900">
      ...
      <form
        className="p-4 border-t border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900 flex gap-2 items-end"
        onSubmit={(e) => {
          e.preventDefault();
          sendMessage();
        }}
